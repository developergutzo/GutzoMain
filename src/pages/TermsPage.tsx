      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 space-y-6">
          <div className="space-y-4 text-gray-700 leading-relaxed">
            ...
            <p>
              This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name gutzo.in ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
            </p>
            <p>
              The Platform is owned by Gutzo, a company incorporated under the Companies Act, 1956 with its registered office at Coimbatore (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our')..
            </p>
            <p>
            ...
            <p>
              All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Coimbatore and Tamil Nadu.
            </p>
            <p>
