...
import { Loader2, LogOut, Store, Star, ChefHat, MapPin, TrendingUp, LayoutDashboard, UtensilsCrossed, ShoppingBag, UserCog, CalendarDays, ReceiptText } from "lucide-react";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export function PartnerDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<'dashboard' | 'menu' | 'meal-plans' | 'orders' | 'gst' | 'profile'>('dashboard');
